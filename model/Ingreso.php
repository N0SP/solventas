		...
		public function Registrar($idusuario, $idsucursal, $idproveedor, $tipo_comprobante, $serie_comprobante, $num_comprobante, $impuesto, $total, $detalle){
			...
			try {
				...
				foreach($detalle as $indice => $valor){
					$sql_detalle = "INSERT INTO detalle_ingreso(idingreso, serie, descripcion, id_marca, id_modelo, color, stock_ingreso, precio_compra)
											VALUES($idingreso, ".$valor[0].", '".$valor[1]."', '".$valor[2]."', '".$valor[3]."', ".$valor[5].", ".$valor[6].")";
...
*/	
	        $sql = "Select * from detalle_ingreso Where id_ingreso = $idingreso";
			$query = $conexion->query($sql);
			return $query;
		}
